...
{
    internal sealed class ColumnEqualityComparer : EqualityComparer<ColumnBase>
    {
        private static bool Equals(NumericColumn x, NumericColumn y)
        {
            return
                ...
                x.Radix == y.Radix &&
                x.Scale == y.Scale &&
                EqualsImpl((ColumnBase)x, (ColumnBase)y);
        }
        ...
        private static bool EqualsImpl(ColumnBase x, ColumnBase y)
        {
            return
                x.Name == y.Name &&
